...
This is the first of 2 sets of exercises
...
To complete the exercises in this workshop, you will need to access
RStudio.
...
💁 Tip: in the R Console or the Terminal, you can cancel a process with `Ctrl + c`.
